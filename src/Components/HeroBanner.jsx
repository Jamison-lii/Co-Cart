      ...
      >
        <div className='absolute inset-0 bg-black md:rounded-2xl bg-opacity-50 flex items-center justify-center'>
          <div className='text-center text-white px-4'>
            <h1 className='text-3xl md:text-5xl lg:text-6xl font-bold mb-4'>Benefit from bulk discounts</h1>
            <p className='text-lg md:text-xl mb-6'>Establish your own Buying Campaign , buy-together,save money</p>
            <button
